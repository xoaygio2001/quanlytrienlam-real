...
<body>
    ...
    <script>
                ...
                var str = data.map((item, index) => {
                    return `
                                <tr>
                                    ...
                                    <td>
                                        <Button onClick="Xemchitiet(${item.ma_trienlam})" class="btn btn-info">Xem Chi Tiết</Button>
                                        <Button onClick="Sua(${item.ma_trienlam})" class="btn btn-primary">Sửa</Button>
                                        <Button onClick="Xoa(${item.ma_trienlam})" class="btn btn-danger">Xóa</Button>
                                    </td>
                                </tr>
                    `
                })
        ...
        function Xemchitiet(id) {
            ...
            location.href = location.origin + `/admin/xemchitiet/trienlam/${id}`

        }

        function Sua(id) {

            location.href = location.origin + `/admin/sua/trienlam/${id}`

        }

        function Xoa(id) {

            var address = location.origin + `/admin/xoa/trienlam/${id}`
            $.ajax({
                url: address,
                type: 'POST',
                data: {
