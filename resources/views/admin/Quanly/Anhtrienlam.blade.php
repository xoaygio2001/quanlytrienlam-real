...
<body>
    ...
    <script>
                ...
                var str = data.map((item, index) => {
                    return `
                                <tr>
                                    ...
                                    <td>${item.tongsoanh}</td>
                                    <td>
                                        <Button
                                            onClick="Xemchitiet(${item.ma_trienlam})"
                                            class="btn btn-info">
                                            Xem Chi Tiết
                                        </Button>
                                        <Button
                                            onClick="Sua(${item.ma_trienlam})"
                                            class="btn btn-primary">
                                            Sửa
                                        </Button>
                                        <Button
                                            onClick="Xoa(${item.ma_trienlam})"
        ...
        function Xemchitiet(id) {
            ...
            window.location = location.origin + `/admin/xemchitiet/anhtrienlam/${id}`

        }

        function Sua(id) {

            window.location = location.origin + `/admin/sua/anhtrienlam/${id}`

        }

        function Xoa(id) {

            var address = location.origin + `/admin/xoa/anhtrienlam/${id}`
            $.ajax({
                url: address,
                type: 'POST',
                data: {
