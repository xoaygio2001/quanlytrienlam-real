            ...
            <div id='main-container' style="height: 150%;">
                ...
                <form style="width: 80%; margin-left: 5%;">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tentrienlam" value="123" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <button onclick="(function(e){e.preventDefault(); Sua() })(event)" type="submit"
    ...
    <script type="text/javascript">
        $(document).ready(function(e) {
            ...
            $.ajax({
                ...
                success: (response) => {
                    ...
                    <form style="width: 80%; margin-left: 5%;">
                    <div class="mb-3">
                        <label for="tentrienlam" class="form-label">Tên Triển Lãm</label>
                        <input type="text" class="form-control" id="tentrienlam"
                        value="${data.ten_trienlam}"
                        >
                    </div>
                    <div class="mb-3">
                        <label for="danhmuc" class="form-label">Danh Mục</label>
                        <select class="form-select" id="danhmuc">
                            <option value=${data.ma_danhmuc}>${data.ten_danhmuc}</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="diadiem" class="form-label">Địa Điểm</label>
                        <input type="text" class="form-control" id="diadiem"
                        value="${data.diachi_trienlam}"
                        >
                    </div>
                    <div class="mb-3">
                        <label for="thoigianbatdau" class="form-label">Thời Gian Bắt Đầu</label>
                    ...
                    <div class="mb-3">
                        <label for="anhdaidien" class="form-label">Ảnh Đại Diện</label>
                        <img style="height:90px" src="${data.anhdaidien}" alt="Ảnh Lỗi">
                        <input class="form-control" type="file" id="anhdaidien">
                    </div>
                    <div class="mb-3">
                        <label for="motatrienlam" class="form-label">Mô Tả Triển Lãm</label>
                        <br>
                        <textarea name="" id="motatrienlam" cols="110" rows="4">${data.mota_trienlam}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="noidungtrienlam" class="form-label">Nội Dung Triển Lãm</label>
                        <br>
                        <textarea name="" id="noidungtrienlam" cols="110" rows="12">${data.noidung_trienlam}</textarea>
                    </div>

                    <button onclick="(function(e){e.preventDefault(); Sua(${data.ma_trienlam}) })(event)" type="submit"
                        class="btn btn-primary">
                        Sửa
                    </button>
                </form> 
                    ...
                    $.ajax({
                        ...
                        `
                            ...
                            select.innerHTML = select.innerHTML + str
        ...
        function Sua(id) {
            ...
            if (tentrienlam.length != 0 && danhmuc.length != 0 && diadiem.length != 0 &&
                thoigianbatdau.length != 0 && thoigianketthuc.length != 0 &&
                ...
                var address = location.origin + `/admin/sua/sua/trienlam/${id}`
                $.ajax({
                    type: 'POST',
                    url: address,
                    data: formData,
